...
ranger_s3bucket=https://s3.amazonaws.com/aws-bigdata-blog/artifacts/aws-blog-emr-ranger/ranger/ranger-0.7.1
...
if [ "$1" == "solr" ]; then
    sudo wget https://s3.amazonaws.com/aws-bigdata-blog/artifacts/aws-blog-emr-ranger/ranger/ranger-0.7.1/solr_for_audit_setup.tar.gz
fi
